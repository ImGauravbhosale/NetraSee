    ...
    <div className="flex min-h-screen items-center justify-center bg-neutral-50 px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-lg font-semibold text-neutral-900">Sign in to NetraSee</h1>
          <p className="mt-1 text-sm text-neutral-500">See your controls. Prove your compliance.</p>
        </div>
        ...
        <p className="mt-4 text-center text-sm text-neutral-500">
          No account? <Link href="/register" className="font-medium text-indigo-600 hover:text-indigo-500">Register your organization</Link>
        </p>
      </div>
    </div>
  );
